...
class Inpainting_WGAN(Inpainting):
    '''
    classdocs
    '''
    ...
    def init_model(self):
        ...
        self.disciminator = self.Discriminate(self.y, output_nonlin=None)
    ...
    def learn_model_WGAN(self, dataset, 
                    batch_size=64, 
                    valid_batch_size=64, 
                    saveto='params/model', 
        ...
        for param in lasagne.layers.get_all_params(self.disciminator, trainable=True):
...
#                     cost = self.f_update(x, y ,dataset.mask)
                    ...
                    if numpy.mod(uidx, validFreq) == 0:
                        ...
                        self.show_examples(dataset, 'WGAN_epoch' + str(eidx) + '.png')
...
if __name__ == '__main__':     
    ...
    model = Inpainting_WGAN()
    model.learn_model_WGAN(dataset, saveto='params/model_GAN.npz')
